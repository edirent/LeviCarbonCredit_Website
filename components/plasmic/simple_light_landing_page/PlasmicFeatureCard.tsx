...
import sty from "./PlasmicFeatureCard.module.css"; // plasmic-import: yFKCfwLmSIjV/css
...
function PlasmicFeatureCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox___03RcG, {
          [sty.freeBoxlong___03RcGyXiYe]: hasVariant($state, "long", "long")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__nVMgR, {
            [sty.freeBoxlong__nVMgRyXiYe]: hasVariant($state, "long", "long")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__kLVd)}
                role={"img"}
              />
            ),
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__qrJa1, {
          [sty.freeBoxlong__qrJa1YXiYe]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__glVgj, {
          [sty.freeBoxlong__glVgjyXiYe]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__tdHxr)}
              role={"img"}
            />
          ),
