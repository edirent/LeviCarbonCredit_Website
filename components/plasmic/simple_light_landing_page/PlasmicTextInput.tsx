...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 5rBBCQDhpHFR/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__hb3Cc)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__tf44M)}
              role={"img"}
            />
          ),
