...
import BaseCard from "../../BaseCard"; // plasmic-import: qbOVsJAhC55F/component
import Bullet from "../../Bullet"; // plasmic-import: y0QDCJCpGOFk/component
...
import sty from "./PlasmicPlan.module.css"; // plasmic-import: BOGQiSSMtWOS/css
...
function PlasmicPlan__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__axwnR)}>
        <div className={classNames(projectcss.all, sty.freeBox__lE4Bo)}>
          {renderPlasmicSlot({
          ...
          {renderPlasmicSlot({
            defaultContents: (
              <div className={classNames(projectcss.all, sty.freeBox__hiIIp)}>
                <Bullet
                  className={classNames("__wab_instance", sty.bullet__tgQpn)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet___19Qfu)}
                />

                <Bullet
                  className={classNames("__wab_instance", sty.bullet__qo5Xx)}
                />
              </div>
            ),
            value: args.description
          })}
          <div className={classNames(projectcss.all, sty.freeBox___1Rp6B)}>
            {renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button___7Z9R5)}
                  color={"outlineBlue"}
                  submitsForm={true}
                >
                  {"Get started"}
