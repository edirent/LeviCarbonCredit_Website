...
import sty from "./PlasmicBaseCard.module.css"; // plasmic-import: qbOVsJAhC55F/css
...
function PlasmicBaseCard__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__ahR3B, {
          [sty.freeBoxlong__ahR3BrO3Gw]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents:
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__ue3RA, {
          [sty.freeBoxlong__ue3RArO3Gw]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__smdDb)}
              role={"img"}
            />
          ),
