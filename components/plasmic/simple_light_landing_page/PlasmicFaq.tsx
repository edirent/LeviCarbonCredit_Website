...
import sty from "./PlasmicFaq.module.css"; // plasmic-import: a8e9ed5ESM1g/css
...
function PlasmicFaq__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__o5Bjz)}>
        <div className={classNames(projectcss.all, sty.freeBox__mpttf)}>
          <div className={classNames(projectcss.all, sty.freeBox__nhNNf)}>
            {renderPlasmicSlot({
