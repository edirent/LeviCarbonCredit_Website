...
import Avatar from "../../Avatar"; // plasmic-import: tHqCfHDdGvDh/component
...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: 1NdGuGY7en5Y/css

import QuoteDashesIcon from "./icons/PlasmicIcon__QuoteDashes"; // plasmic-import: XnGrwve7Vbkg/icon
...
function PlasmicTestimonial__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__oBdr0)}>
        <div
          className={classNames(
            projectcss.all,
        ...
        <div className={classNames(projectcss.all, sty.freeBox___9FBzF)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
